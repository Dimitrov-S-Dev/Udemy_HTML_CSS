...
sayHello();
sayHello();
// Writing a function declaration with parameters.

function sayHi(name, mood){
    alert("Hello " + name);
    alert("I understand your mood is " + mood);
}
...
// Calling function and getting the return value.

let my_Number = parseInt(prompt("Enter a number: "));
let sum = addFive(my_Number);
alert(sum);
