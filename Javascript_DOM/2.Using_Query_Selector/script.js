/*
    We can access elements of the HTML document using the querySelector method.
    While getElementById allows us to select an element based off an id we gave in the HTML,
    querySelector uses the same selector methods as our CSS...
    Which means we can use more complicated selection options.
    When using querySelector, you must use appropriate CSS selection methods such as # and .
*/
...
/*
    ...
    We can create elements for the document and append them to our main tag.
*/
...
/*
    To select ALL elements that meet the search criteria we can use querySelectorAll().
